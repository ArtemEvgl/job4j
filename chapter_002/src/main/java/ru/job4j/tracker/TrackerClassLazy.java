...
public class TrackerClassLazy {
    private TrackerClassLazy() {
    }

    public static TrackerClassLazy getInstance() {
    ...
    private static final class Holder {
        private static final TrackerClassLazy INSTANCE = new TrackerClassLazy();
    }
}
